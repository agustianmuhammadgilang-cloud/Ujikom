                ...
                <form action="/admin/kategori/update/<?= $kategori['id_kategori'] ?>" method="post">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" 
                               ...
                               required 
                               autofocus>
                        <div class="form-text small text-muted">Ubah nama kategori sesuai dengan kelompok alat yang diinginkan.</div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-primary px-4 shadow-sm">
                            <i class="bi bi-arrow-repeat me-2"></i> Perbarui Kategori
                        </button>
                    </div>
                </form>
            </div>
