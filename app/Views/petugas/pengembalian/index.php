        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr class="<?= ($p['status_pengembalian'] == 'diajukan' && empty($p['id_pengembalian'])) ? 'table-warning' : '' ?>">
                        ...
                        <td class="text-center">
                            ...
                            <?php if (empty($p['id_pengembalian'])): ?>
                                ...
                                <?php if ($p['status_pengembalian'] == 'diajukan'): ?>
                                    <span class="badge rounded-pill bg-warning-subtle text-warning border px-3 fw-medium">
                                        Akan Dikembalikan
                                    </span>
                                <?php else: ?>
                                    <span class="badge rounded-pill bg-light text-secondary border px-3 fw-normal">
                                        Belum Dikembalikan
                                    </span>
                                <?php endif; ?>
                            ...
                            <?php else: ?>
                                ...
                                <?php if ($p['denda'] == 0): ?>
                                    <span class="badge rounded-pill bg-success-subtle text-success border border-success-subtle px-3 fw-medium">
                                        Tidak Ada Denda
                                    </span>
                                <?php else: ?>

                                    <?php if ($p['status_denda'] == 'sudah_bayar'): ?>
                                        <span class="badge rounded-pill bg-success text-white px-3 fw-medium">
                                            Lunas
                                        </span>
                                    <?php else: ?>
                                        <span class="badge rounded-pill bg-danger-subtle text-danger border border-danger-subtle px-3 fw-medium">
                                            Belum Bayar
                                        </span>
                                    <?php endif; ?>
                        ...
                        <td class="text-center">
                            ...
                            <?php if (empty($p['id_pengembalian'])): ?>
                                ...
                                <a href="/petugas/pengembalian/proses/<?= $p['id_peminjaman'] ?>" 
                            ...
                            <?php else: ?>
                                ...
                                <?php if ($p['denda'] > 0 && $p['status_denda'] == 'belum_bayar'): ?>
                                    ...
                                    <a href="/petugas/pengembalian/bayar/<?= $p['id_pengembalian'] ?>" 
